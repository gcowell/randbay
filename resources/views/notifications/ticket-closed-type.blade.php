...
<div class="col-md-7">
    <div class="row">
        <p>Your support ticket for: "{{ $notification->item_description }}" has been resolved by a moderator.</p>
        <p>Please review the result <a href=/support/{{ $notification->item_support_ticket_id}} >here.</a></p>
    </div>
    <div class="row">
