...
<div class="col-md-7">
    <div class="row">
        <p>Your support ticket has been updated: <a href=/transactions/{{ $notification->transaction_id }}>{{ $notification->item_description }}</a> </p>
        <p>You can view it <a href=/support/{{ $notification->item_support_ticket_id}} >here.</a></p>
    </div>
    <div class="row">
