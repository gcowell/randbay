...
<div class="col-md-8">
    <div class="row">
        <p>Your sold item <a href=/transactions/{{ $notification->transaction_id }}>{{ $notification->item_description }}</a> has been rated by the buyer at {{ $notification->item_rating }} stars!</p>
    </div>
    <div class="row">
